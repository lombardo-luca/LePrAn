...
@dataclass
class LoadedStats:
    """Simple container for loaded CSV statistics."""
    films_num: int
    total_hours: float
    total_days: float
    username: str
...
class StatisticsCSVHandler:
    ...
    def save_to_csv(self, username: str, scraped_at: str, films_num: int, 
                    total_hours: float, total_days: float, csv_path: str) -> bool:
...
class DataPopulator:
    ...
    def __init__(self, gui_models, config) -> None:
        """Initialize with GUI models and configuration."""
        self.gui_models = gui_models
        self.config = config
    
    def populate_all_models(self, stats_data, films_num: int) -> None:
...
class GUIStringGenerator:
    ...
    def __init__(self, stats_data, config) -> None:
    ...
    def _generate_country_strings(self, films_num: int) -> None:
...
class DataManager:
    ...
    def save_stats_to_csv(self, username: str, scraped_at: str, films_num: int, 
                          total_hours: float, total_days: float, csv_path: str) -> bool:
