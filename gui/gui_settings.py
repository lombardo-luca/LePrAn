...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        # Scraper profile combobox removed - only TMDB API is now supported
        self.label_3 = QtWidgets.QLabel(parent=self.layoutWidget_2)
        self.label_3.setText("(Only TMDB API is supported)")
        font = QtGui.QFont()
        font.setFamily("Inter V Medium")
        font.setPointSize(9)
        font.setItalic(True)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "(Only TMDB API is supported)"))
