...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox.setItemText(0, _translate("Dialog", "TMDB API (CSV import)"))
        self.comboBox.setItemText(1, _translate("Dialog", "Async (fastest)"))
        self.comboBox.setItemText(2, _translate("Dialog", "Optimized (normal)"))
        self.comboBox.setItemText(3, _translate("Dialog", "Legacy (slowest)"))
